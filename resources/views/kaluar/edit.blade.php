...
<div class="col-12 col-xl-12">
    <div class="card">
        <div class="card-body p-4">
            <h5 class="mb-4">Edit Barang {{ $kaluar->nama }}</h5>
            <form class="row g-3" method="POST" action="{{ route('kaluar.update', $kaluar->id) }}"
               ...
               <div class="mb-3">
                ...
                <div class="col-md-12">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                        ...
                        <a type="submit" href="{{route('kaluar.index')}}" class="btn btn-danger">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
