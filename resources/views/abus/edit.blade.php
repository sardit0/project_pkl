...
<div class="col-12 col-xl-12">
    <div class="card">
        <div class="card-body p-4">
            <h5 class="mb-4">Edit Barang {{ $abus->nama }}</h5>
            <form class="row g-3" method="POST" action="{{ route('abus.update', $abus->id) }}"
               ...
               <div class="mb-3">
                ...
                <div class="col-md-12">
                    <label for="input17" class="form-label">Tanggal Masuk</label>
                    <div class="position-relative input-icon">
                        <input type="date" name="tanggal_masuk" class="form-control" id="input17">
                        <span class="position-absolute top-50 translate-middle-y"></span>
                    </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                        ...
                        <a type="submit" href="{{route('abus.index')}}" class="btn btn-danger">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
